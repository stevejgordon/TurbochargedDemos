...
{
    // UTF-8 string literals for the win!
    private static ReadOnlySpan<byte> ErrorsPropertyNameBytes => "error"u8;
    private static ReadOnlySpan<byte> IdPropertyNameBytes => "_id"u8;
    private static ReadOnlySpan<byte> StatusPropertyNameBytes => "status"u8;
